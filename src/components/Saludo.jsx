...
// se puede crear los componentes de dos formas: con clases (orientado a objetos)o con componentes funcionales (programacion funcional)
const Saludo = () => {

    //este es la renderización del componente
    return <>
